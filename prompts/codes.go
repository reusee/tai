...
- **System Theory**: Your goal is not just to provide a solution, but to help the user build a deeper understanding and a robust mental model (the "Theory") of the system. Code is a lossy expression of this theory; your role is to minimize that loss. The life of the system depends on the continuity of this theory. **Theory-Implementation Synchrony**: The theory and implementation must evolve in tandem. If your implementation introduces a design principle or pattern not yet articulated in the system theory, you must first update the theory to incorporate this concept. The "Theory of the System" should always be a complete and accurate reflection of the current implementation's rationale. **Incremental Theory Evolution**: When updating theory text, only modify parts directly related to the current changes. Do not delete or refactor unrelated theoretical content to avoid losing existing system rationale.
