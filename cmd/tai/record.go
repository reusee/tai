...
(the auto-detected default, ai, next) records through the unified
generation loop. The record subcommand works regardless of whether
recording is enabled, because the interaction database is opened on every
run.
